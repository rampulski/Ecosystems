...
public class OpenNIDepthmapToMesh : MonoBehaviour
{
    ...
    void UpdateDepthmapMesh()
    {
        if (meshFilter == null)
            return;
        UnityEngine.Profiling.Profiler.BeginSample("UpdateDepthmapMesh");
        mesh.Clear();
    ...
    {
        UnityEngine.Profiling.Profiler.BeginSample("UpdateUVs");
        mesh.uv = uvs;
        UnityEngine.Profiling.Profiler.EndSample();
    }
    ...
    {
        UnityEngine.Profiling.Profiler.BeginSample("UpdateTriangleIndices");
